...
class MWOpenGLRender
{
  ...
  public:
    ...
    void close();
    int32_t render(uint8_t *data, mw_render_ctrl_t *rctrl);
  ...
  private:
    ...
    void render_tex(int tex_index, GLenum internalformat, int32_t tex_w, int tex_h, GLenum format, GLenum tex_type, char *p_tex_name, uint8_t *p_data);
